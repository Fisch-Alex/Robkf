...
#' 
#' @export
AORKF_huber = function(Y,mu_0,Sigma_0=NULL,A,C,Sigma_Add,Sigma_Inn,h=2,epsilon)
{
  ...
  algo_output  = aorkf_huber_list(mu_init,Sigma_init,ys_list,A,b,C,d,Sigma_Add,Sigma_Inn,h)
